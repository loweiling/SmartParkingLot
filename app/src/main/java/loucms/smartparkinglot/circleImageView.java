...
public class circleImageView extends AppCompatImageView {
    ...
    private static final int DEFAULT_BORDER_COLOR2 = Color.TRANSPARENT;
    ...
    public circleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth2 = a.getDimensionPixelSize(R.styleable.circleImageView_border_width, DEFAULT_BORDER_WIDTH);
        // 获取边界的颜色
        mBorderColor = a.getColor(R.styleable.circleImageView_border_color, DEFAULT_BORDER_COLOR);
        mBorderColor2 = a.getColor(R.styleable.circleImageView_border_color, DEFAULT_BORDER_COLOR2);
    ...
    public void setOutsideBorderColor(int borderColor) {
        if (borderColor == mBorderColor2) {
            return;
        }

        mBorderColor2 = borderColor;
        mBorderPaint2.setColor(mBorderColor2);
        invalidate();
    }
    public void setOutsideBorderColorResource(@ColorRes int borderColorRes) {
        setOutsideBorderColor(getContext().getResources().getColor(borderColorRes));
    }
    ...
    private void setup() {
        ...
        //
        mBorderPaint2.setStyle(Paint.Style.STROKE);//设画笔为空心
        mBorderPaint2.setAntiAlias(true);
        mBorderPaint2.setColor(mBorderColor2);    //画笔颜色
        mBorderPaint2.setStrokeWidth(mBorderWidth2);//画笔边界宽度
        ...
        mBorderRect.set(0, 0, getWidth()-25, getHeight()-25);
        ...
        //
        mBorderRadius2 = mBorderRadius+8;
    ...
    private void updateShaderMatrix() {
        ...
        // 平移
        mShaderMatrix.postTranslate((int) (dx + 0.5f) + mDrawableRect.left+13, (int) (dy + 0.5f) + mDrawableRect.top+18f);
        // 设置变换矩阵
